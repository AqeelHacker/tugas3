...
import 'package:tugas_3/widget/grade_form.dart'; 

class AverageScorePage extends StatefulWidget {
  const AverageScorePage({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          GradeForm(onResult: _onResult, isAveragePage: true), // Indicate this is for average
          const SizedBox(height: 20),
